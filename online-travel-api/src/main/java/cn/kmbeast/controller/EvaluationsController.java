...
public class EvaluationsController {
    ...
    @ResponseBody
    @RateLimit(count = 10, seconds = 60, message = "评论过于频繁，请稍后再试", target = RateLimitTarget.USER, key = "evaluations:insert")
    ...
    @ResponseBody
    @RateLimit(count = 20, seconds = 60, message = "点赞操作过于频繁，请稍后再试", target = RateLimitTarget.USER, key = "evaluations:upvote")
